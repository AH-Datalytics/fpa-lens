...
export const TurfPage: GlobalConfig = {
  ...
  fields: [
    ...
    { name: "operationalNoteBody1", type: "richText", defaultValue: () => TURF_DEFAULTS.operationalNoteBody1, admin: { description: "First paragraph of the Operational Note callout." } },
    { name: "operationalNoteBody2", type: "richText", defaultValue: () => TURF_DEFAULTS.operationalNoteBody2, admin: { description: "Second paragraph of the Operational Note callout." } },
    ...
    { name: "statusExplainer", type: "richText", defaultValue: () => TURF_DEFAULTS.statusExplainer, admin: { description: "Operational-indicator caveat paragraph in the how-to-read box." } },
  ],
};

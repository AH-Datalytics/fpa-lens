...
export const TurfPage: GlobalConfig = {
  ...
  fields: [
    { name: "pageTitle", label: "Page title", type: "text", defaultValue: () => TURF_DEFAULTS.pageTitle, admin: { description: "Page title (top section header)." } },
    { name: "pageSubtitle", label: "Page subtitle", type: "text", defaultValue: () => TURF_DEFAULTS.pageSubtitle, admin: { description: "Subtitle beneath the page title." } },
    { name: "planEyebrow", label: "Plan: eyebrow label", type: "text", defaultValue: () => TURF_DEFAULTS.planEyebrow, admin: { description: "Small eyebrow label above the plan hero heading." } },
    { name: "systemOverviewTitle", label: "System Overview: heading", type: "text", defaultValue: () => TURF_DEFAULTS.systemOverviewTitle, admin: { description: "Heading for the System overview section." } },
    { name: "operationalNoteHeading", label: "Operational Note: heading", type: "text", defaultValue: () => TURF_DEFAULTS.operationalNoteHeading, admin: { description: "Heading for the dated Operational Note callout." } },
    { name: "operationalNoteBody1", label: "Operational Note: paragraph 1", type: "richText", defaultValue: () => TURF_DEFAULTS.operationalNoteBody1, admin: { description: "First paragraph of the Operational Note callout." } },
    { name: "operationalNoteBody2", label: "Operational Note: paragraph 2", type: "richText", defaultValue: () => TURF_DEFAULTS.operationalNoteBody2, admin: { description: "Second paragraph of the Operational Note callout." } },
    { name: "mapTitle", label: "Zone Map: heading", type: "text", defaultValue: () => TURF_DEFAULTS.mapTitle, admin: { description: "Heading above the interactive zone map." } },
    { name: "mapSubtitle", label: "Zone Map: subtitle", type: "text", defaultValue: () => TURF_DEFAULTS.mapSubtitle, admin: { description: "Explainer subtitle above the interactive zone map." } },
    { name: "howToReadHeading", label: "How to Read the Cards: heading", type: "text", defaultValue: () => TURF_DEFAULTS.howToReadHeading, admin: { description: "Heading for the 'How to read the zone cards' box." } },
    { name: "statusExplainer", label: "How to Read the Cards: explainer", type: "richText", defaultValue: () => TURF_DEFAULTS.statusExplainer, admin: { description: "Operational-indicator caveat paragraph in the how-to-read box." } },
  ],
};
